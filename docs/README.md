...
Living notes for running the household agent: credentials, services, and provider-neutral chat commands.

| Page | What’s here |
| :--- | :--- |
| [Services & credentials](./services-and-credentials.md) | APIs, OAuth, env vars, what breaks if something is missing |
| [Setup commands](./commands/setup.md) | Signal and Telegram identity configuration, `/whoami`, `/chat`, `/login` |
...
| [Historical Signal vs Telegram notes](./signal-vs-telegram.md) | Pre-pluggable-transport comparison retained for context |
